...
*@param question String a la pregunta.
*@param answer String con la respuesta.
*/
exports.update = (id,question,answer) => {
  ...
  if(typeof quiz==="undefined"){
    throw new Error("El valor del paramtro id no es válido");
  }
  quizzes.splice(id,1, {
    question: (question || "").trim(),
    answer: (answer || "").trim()
...
*objeto nuevo con todas las preguntas existntes.
...
*
*@param id Clave que identica el quiz a devolver
*
